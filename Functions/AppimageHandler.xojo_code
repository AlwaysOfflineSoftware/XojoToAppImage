		...
		Sub CheckForImage()
		  Try
		    If(SpecialFolder.CurrentWorkingDirectory.Child(App.programName+"-x86_64.AppImage").exists) Then
		      Utils.GeneratePopup(1,"Success!","The AppImage seems to be created! Please validate before distributing.")
		    Else
		      Utils.GeneratePopup(3,"Something Failed...","The AppImage was not found in user home.")
		    End
		  Catch e As RuntimeException
		    Utils.GeneratePopup(1,"Something went wrong!",e.message)
		  End
